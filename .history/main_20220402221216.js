window.addEventListener("load", function(){
    ...
    const list= ["ChacAiDoSeVe.mp3", "ChayNgayDi.mp3", "CoChacYeuLaDay.mp3", "HayTraoChoAnh.mp3",
     "LacTroi.mp3", "MuonRoiMaSaoCon.mp3", "NoiNayCoAnh.mp3"];
    const list1 = [
        {
    ...
    //------------------------------- AlbumAuthorItem
    [...albumAuthorItem].forEach(item =>  item.addEventListener("click",ClickAlbumAuthorItem) );
    function clickAlbumAuthorItem(e){
        [...albumAuthorItem].forEach(function(item) {
            let dataAlbumAuthor = e.currentTarget.dataset.item;
        })
        console.log(dataAlbumAuthor);
    }
